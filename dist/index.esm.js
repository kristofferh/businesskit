import React, { createContext, forwardRef, createElement, Component, Fragment, useContext, useState, useRef, useEffect } from 'react';
...
var Badge = function (_a) {
    ...
    return (React.createElement(Container$1, { className: className, variant: variant, colorScheme: colorScheme, sx: sx },
        React.createElement(Inner, null, children),
        isRemovable && (React.createElement(RemoveContainer, __assign({}, removeProps),
            React.createElement(Remove, __assign({}, removeProps),
                React.createElement(CloseIcon, { width: SIZE, height: SIZE, color: removeColor }))))));
};
Badge.defaultProps = {
    variant: "solid",
    removeColor: white,
