...
var Loader = function (_a) {
    ...
    return (React__default.createElement(Container, { containerSize: size, style: style, className: className },
        React__default.createElement(SVG, { dashAnimation: showDashAnimation, height: size, width: size, viewBox: "0 0 40 40" },
            React__default.createElement("g", { fill: "none" },
                ...
                React__default.createElement(Spinner, { dashAnimation: showDashAnimation, className: spinnerClassName, style: spinnerStyle, stroke: color, strokeWidth: borderWidth, r: (size - borderWidth) / 2, cx: "50%", cy: "50%" })))));
};
Loader.defaultProps = {
