...
var gray = function (variant, theme) {
...
var Container$1 = newStyled("span")({
    ...
    var variant = _a.variant, theme = _a.theme, colorScheme = _a.colorScheme;
...
var Badge = function (_a) {
    var children = _a.children, isRemovable = _a.isRemovable, removeProps = _a.removeProps, removeColor = _a.removeColor, sx = _a.sx, className = _a.className, variant = _a.variant, colorScheme = _a.colorScheme;
    return (React__default.createElement(Container$1, { className: className, variant: variant, colorScheme: colorScheme, sx: sx },
        React__default.createElement(Inner, null, children),
        isRemovable && (React__default.createElement(RemoveContainer, __assign({}, removeProps),
            React__default.createElement(Remove, __assign({}, removeProps),
                React__default.createElement(CloseIcon, { width: SIZE, height: SIZE, color: removeColor }))))));
};
Badge.defaultProps = {
    variant: "solid",
    removeColor: white,
