...
var getServerStylisCache$1 = isBrowser$3 ? undefined : weakMemoize(function () {
...
var createCache$1 = function createCache(options) {
  ...
  var omnipresentPlugins = [compat, removeLabel$1];
...
var EmotionCacheContext$1 = /* #__PURE__ */React.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
// because this module is primarily intended for the browser and node
// but it's also required in react native and similar environments sometimes
// and we could have a special build just for that
// but this is much easier and the native packages
  ...
  withEmotionCache$1 = function withEmotionCache(func) {
    return function (props) {
      ...
      if (cache === null) {
        ...
        return /*#__PURE__*/React.createElement(EmotionCacheContext$1.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var createEmotionProps = function createEmotionProps(type, props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (error.stack) {
      ...
      if (match) {
        newProps[labelPropName$1] = sanitizeIdentifier(match[1]);
      }
    }
  }
...
var Emotion$1 = /* #__PURE__ */withEmotionCache$1(function (props, cache, ref) {
  ...
  var serialized = serializeStyles$1(registeredStyles, undefined, typeof cssProp === 'function' || Array.isArray(cssProp) ? React.useContext(ThemeContext$1) : undefined);
...
var Loader = function (_a) {
    ...
    var _b = React.useState(100), spinnerLength = _b[0], setSpinnerLength = _b[1];
    ...
    return (React__default.createElement(Container, { containerSize: size, style: style, className: className },
        React__default.createElement(SVG, { dashAnimation: showDashAnimation, height: size, width: size, viewBox: "0 0 " + size + " " + size },
            React__default.createElement("g", { fill: "none" },
                showBackground ? (React__default.createElement("circle", { stroke: backgroundColor, strokeWidth: borderWidth, r: (size - borderWidth) / 2, cx: "50%", cy: "50%" })) : null,
                React__default.createElement(Spinner, { ref: spinnerRef, dashAnimation: showDashAnimation, className: spinnerClassName, style: spinnerStyle, stroke: color, strokeWidth: borderWidth, r: (size - borderWidth) / 2, cx: "50%", cy: "50%", spinnerLength: spinnerLength })))));
};
Loader.defaultProps = {
...
function jsx(type, props, key) {
  ...
  return jsxRuntime.jsx(Emotion$1, createEmotionProps(type, props), key);
}
function jsxs(type, props, key) {
  ...
  return jsxRuntime.jsxs(Emotion$1, createEmotionProps(type, props), key);
}

var SVGIcon = function (_a) {
    var _b = _a.width, width = _b === void 0 ? 24 : _b, _c = _a.height, height = _c === void 0 ? 24 : _c, _d = _a.viewBox, viewBox = _d === void 0 ? "0 0 24 24" : _d, className = _a.className, color = _a.color, children = _a.children, rest = __rest(_a, ["width", "height", "viewBox", "className", "color", "children"]);
    return (React__default.createElement("svg", __assign({ className: className, width: width, height: height, viewBox: viewBox, fill: color }, rest), children));
};

var Close = function (props) { return (React__default.createElement(SVGIcon, __assign({}, props),
...
var Container$1 = newStyled("span")({
...
var Badge = function (_a) {
    var children = _a.children, isRemovable = _a.isRemovable, removeProps = _a.removeProps, removeColor = _a.removeColor, sx = _a.sx, className = _a.className, variant = _a.variant;
    return (jsxs(Container$1, __assign({ className: className, variant: variant, sx: sx }, { children: [jsx(Inner, { children: children }, void 0),
            isRemovable && (jsx(RemoveContainer, __assign({}, removeProps, { children: jsx(Remove, __assign({}, removeProps, { children: jsx(CloseIcon, { width: SIZE, height: SIZE, color: removeColor }, void 0) }), void 0) }), void 0))] }), void 0));
};
Badge.defaultProps = {
    variant: "solid",
    removeColor: white,
...
var Provider = function (_a) {
    ...
    return React__default.createElement(ThemeProvider, { theme: theme$1 }, children);
};
